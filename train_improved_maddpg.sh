...
echo "Starting improved MADDPG navigation training with:"
echo "Map: $MAP_NUMBER"
...
ros2 launch start_reinforcement_learning start_learning.launch.py algorithm:=maddpg map_number:=$MAP_NUMBER robot_number:=$ROBOT_NUMBER
