...
echo "Evaluating MADDPG model with:"
echo "Map: $MAP_NUMBER"
...
ros2 run start_reinforcement_learning run_maddpg_evaluate --ros-args -p map_number:=$MAP_NUMBER -p robot_number:=$ROBOT_NUMBER -p model_episode:=$MODEL_EPISODE
